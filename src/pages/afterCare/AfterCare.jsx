const AfterCare = () => {
    return (
      <div className="max-w-3xl mx-auto p-6 my-6 dark:text-white shadow-lg rounded-lg">
        <h1 className="text-4xl font-bold text-center text-primary mb-10">After care & Rådgivning</h1>
        ...
        <div className="mt-6">
          ...
          <ul className="list-disc list-inside mt-2 dark:text-white text-gray-700">
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <p className="text-gray-600 dark:text-white">💎 Läkningstid: 6-12 veckor (örsnibb), 6-9 månader (brosk)</p>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-white">💎 Läkningstid: 6-12 veckor (näsvinge), 6-9 månader (septum)</p>
              <ul className="list-disc list-inside text-gray-700">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-white">💎 Läkningstid: 4-8 veckor</p>
              <ul className="list-disc list-inside text-gray-700">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-white">💎 Läkningstid: 6-12 månader</p>
              <ul className="list-disc list-inside text-gray-700">
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-700 dark:text-white">⏳ Vänta alltid tills piercingen är helt läkt innan du byter smycke.</p>
          <p className="text-gray-700 dark:text-white">💡 Tips: Använd smycken i titan eller kirurgiskt stål för att minimera allergiska reaktioner.</p>
        </div>
      </div>
    );
  };
